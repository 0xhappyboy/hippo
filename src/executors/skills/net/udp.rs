...
impl Skill for UdpSendSkill {
    ...
    fn parameters(&self) -> Vec<SkillParameter> {
        ...
        vec![
            SkillParameter {
                ...
                required: true,
                default: Some(Value::String(config.udp_host.clone())),
            ...
            SkillParameter {
                ...
                required: true,
                default: Some(Value::Number(config.udp_port.into())),
            ...
            SkillParameter {
                ...
                required: false,
                default: Some(Value::String(config.udp_encoding.clone())),
            ...
            SkillParameter {
                ...
                required: false,
                default: Some(Value::Number(config.udp_timeout.into())),
    ...
    fn example_output(&self) -> String {
        "Successfully sent 11 bytes to localhost:9999".to_string()
    }
    ...
    async fn execute(&self, parameters: &HashMap<String, Value>) -> Result<String> {
        ...
        let host = parameters
            .get("host")
            .and_then(|v| v.as_str())
            .unwrap_or_else(|| config.udp_host.as_str());
        let port = parameters
            .get("port")
            .and_then(|v| v.as_u64())
            .unwrap_or(config.udp_port.into()) as u16;
        ...
        let encoding = parameters
            .get("encoding")
            .and_then(|v| v.as_str())
            .unwrap_or_else(|| config.udp_encoding.as_str());
        let timeout_secs = parameters
            .get("timeout")
            .and_then(|v| v.as_u64())
            .unwrap_or(config.udp_timeout);
